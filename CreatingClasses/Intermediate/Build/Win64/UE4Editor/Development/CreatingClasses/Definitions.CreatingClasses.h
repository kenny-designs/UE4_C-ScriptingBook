#undef CREATINGCLASSES_API
#undef CREATINGCLASSES_VTABLE
...
#define UE_PROJECT_NAME CreatingClasses
...
#define CREATINGCLASSES_VTABLE DLLEXPORT_VTABLE
#define CREATINGCLASSES_API DLLEXPORT
